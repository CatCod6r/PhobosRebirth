...
public class MathUtil extends Util {
    ...
    public static boolean areVec3dsAlignedRetarded(Vec3d vec3d1, Vec3d vec3d2) {
        BlockPos pos1 = new BlockPos((int) vec3d1.getX(), (int) vec3d1.getY(), (int) vec3d1.getZ());
        BlockPos pos2 = new BlockPos((int) vec3d1.getX(), (int) vec3d1.getY(), (int) vec3d1.getZ());
    ...
    public static Vec3d extrapolatePlayerPosition(PlayerEntity player, int ticks) {
        ...
        Vec3d movement = null;
        double distance = MathUtil.multiply(movement.x) + MathUtil.multiply(movement.y) + MathUtil.multiply(movement.z);
